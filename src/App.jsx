  ...
  return (
    <div className="app pt-10 min-h-screen grid">
      ...
      <main
       ...
       items-start"
      >
        <div className="px-5 grid gap-5 py-5 w-full">
          <h1 className="text-6xl sm:text-8xl font-bold">Agents</h1>
          <div className="grid gap-10 grid-flow-col place-items-center overflow-x-scroll bg-white shadow-md rounded-xl p-8">
            {agents ? (
        ...
        <div className="px-5 grid gap-5 py-5 w-full">
          ...
          <div className="grid gap-10 sm:grid-flow-col place-items-center sm:overflow-x-scroll bg-white shadow-md rounded-xl p-8">
            {maps ? (

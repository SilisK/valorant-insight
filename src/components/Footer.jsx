export default function Footer() {
  return (
    <footer className="bg-slate-400 w-full grid md:grid-flow-col md:place-items-center gap-10 p-10">
      <div>
        ...
        <p className="grid grid-flow-col place-items-center w-max">
          <p>kleemoffdeveloper@gmail.com</p>
          <img
            src="https://www.svgrepo.com/show/513766/copy.svg"
            className="gizmo cursor-pointer"
            onClick={() =>

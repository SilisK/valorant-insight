export default function Footer() {
  return (
    <footer className="w-full border-slate-300 border-t-4 grid gap-3 text-center place-items-center sm:grid-flow-col items-center sm:justify-between py-5 px-8">
